...
import com.tikal.course.java.service.impl.People8Impl;
...
//        Person person = new Person();
    ...
    public static  void collections(People people){
        people.addPerson(new Male(1,"chaim","turkel",22,2));
        people.addPerson(new Male(2, "yossi", "cohen", 20, 2));
        people.addPerson(new Female(3, "dana", "cohen", 19));
    ...
    public static void main(String[] args) {
        ...
        System.out.println("***********************");
        System.out.println("collections - 8");
        collections(new People8Impl());
    }
